...
namespace SocGenCosmosDemo
{
    class Program
    {
        ...
        private async Task CreateDatabaseAsync()
        {
            ...
            {
                throw new InvalidOperationException("CosmosDB client is invalid");
            }
        ...
        private async Task CreateContainerAsync()
        {
            if (database is null)
            {
                throw new InvalidOperationException("Database reference is invalid");
            }
        ...
        private async Task AddItemsToContainerAsync()
        {
            ...
            {
                throw new InvalidOperationException("Container reference is invalid");
            }
        ...
        private async Task ReplaceFamilyItemAsync()
        {
            ...
            if (itemBody is null || itemBody.Children is null || itemBody.Children.Count() == 0 || itemBody.Children[0] is null)
            {
                throw new InvalidOperationException("Item body detail is invalid");
            }
